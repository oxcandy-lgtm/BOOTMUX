...
roadmap_status:
  ...
  V2:
    status: IMPLEMENTED_PATH_PENDING_VM_PROVIDER_AND_PHYSICAL_RETURN
  V3:
    status: IMPLEMENTED_INSTALL_HARNESS_PENDING_CLEAN_ARM64_VM
  V4:
    status: IMPLEMENTED_BOUNDED_CODEX_ADAPTER_PENDING_RUNTIME
  V5:
    status: OPEN_NETWORK_PROOF_PENDING_PERSONAL_HOTSPOT_RUN
  V6:
    status: OPEN_REPEATABLE_INTEGRATED_DEMO_PENDING
```
