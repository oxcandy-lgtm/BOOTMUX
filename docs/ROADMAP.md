...
roadmap_status:
  ...
  V2:
    status: VM_RUNTIME_VERIFIED_AWAITING_PHYSICAL_IPHONE_RETURN
  V3:
    status: OFFICIAL_CODEX_INSTALL_VERIFIED_AWAITING_HUMAN_AUTH
  V4:
    status: BOUNDED_CODEX_ADAPTER_TESTED_AWAITING_AUTH_AND_PHYSICAL_RETURN
  V5:
    status: VM_NAT_EGRESS_VERIFIED_AWAITING_IPHONE_HOTSPOT_RUN
  V6:
    status: INTEGRATED_VM_HARNESS_VERIFIED_AWAITING_AUTH_AND_PHYSICAL_RETURN
```
